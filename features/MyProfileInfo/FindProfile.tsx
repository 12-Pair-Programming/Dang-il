...
const FindProfile = () => {
  ...
  return isMyProfile && user?.name ? (
    <div className="flex flex-col bg-white items-center justify-center px-[auto] w-[full] tablet:px-8 mobile:px-3">
      <div className="flex py-[60px] mx-[auto] w-[983px] px-[auto] flex-col items-start justify-center self-stretch bg-white gap-2 tablet:w-full mobile:w-full">
        <div className="flex flex-row px-[auto] items-start justify-between self-stretch bg-white tablet:flex-col mobile:flex-col ">
          <p className="text-black text-[28px] font-bold whitespace-nowrap mobile:text-xl">
            내 프로필
          </p>
          <div className="flex  flex-col items-start gap-2 self-stretch ">
            <div className="flex p-8 flex-row justify-between items-start gap-2 rounded-xl bg-purple-10 tablet:w-full mobile:w-full tablet:h-full mobile:h-full">
    ...
    <div className="flex pt-[100px] pb-[610px] w-full px-[auto] flex-col items-center gap-2 bg-white tablet:px-8 mobile:px-3 ">
      <div className="w-[983px] tablet:w-full mobile:w-full tablet:px-8 mobile:px-3">
